...
const CardSwap: React.FC<CardSwapProps> = ({
  ...
  useEffect(() => {
    ...
    const swap = () => {
      if (focusedIndex.current !== null) return;
  ...
  const focusCard = (idx: number) => {
    if (isAnimatingFocus.current) return;
    if (focusedIndex.current === idx) return;
      ...
      ? cloneElement(child, {
          ...
          onClick: (e) => {
            ...
            if (order.current[0] === i) {
              focusedIndex.current === i ? unfocusCard() : focusCard(i);
            }
  ...
  return (
    <div
      ...
      origin-bottom-right perspective-[900px]
      overflow-visible
